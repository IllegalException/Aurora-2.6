...
public class EntityUtil
{
    ...
    public static Vec3d getInterpolatedRenderPos(final Entity entity, final float ticks) {
        return getInterpolatedPos(entity, ticks).subtract(((IRenderManager)Wrapper.getMinecraft()).getRenderPosX(), ((IRenderManager)Wrapper.getMinecraft()).getRenderPosY(), ((IRenderManager)Wrapper.getMinecraft()).getRenderPosZ());
    }
    
    public static Vec3d getInterpolatedRenderPos(final Vec3d vec) {
        return new Vec3d(vec.x, vec.y, vec.z).subtract(((IRenderManager)Wrapper.getMinecraft()).getRenderPosX(), ((IRenderManager)Wrapper.getMinecraft()).getRenderPosY(), ((IRenderManager)Wrapper.getMinecraft()).getRenderPosZ());
    }
