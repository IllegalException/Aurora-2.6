...
public class TrajectoryCalculator
{
    ...
    public static double[] interpolate(final Entity entity) {
        final double posX = interpolate(entity.posX, entity.lastTickPosX) - ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosX();
        final double posY = interpolate(entity.posY, entity.lastTickPosY) - ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosY();
        final double posZ = interpolate(entity.posZ, entity.lastTickPosZ) - ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosZ();
    ...
    public static final class FlightPath
    {
        ...
        public FlightPath(final EntityLivingBase entityLivingBase, final ThrowingType throwingType) {
            ...
            this.setLocationAndAngles(ipos[0] + ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosX(), ipos[1] + this.shooter.getEyeHeight() + ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosY(), ipos[2] + ((IRenderManager)Wrapper.getMinecraft().getRenderManager()).getRenderPosZ(), this.shooter.rotationYaw, this.shooter.rotationPitch);
